...
namespace game
{
	static const std::map<ActorType, ActorTypeDescriptor> descriptors =
	{
		...
		{ActorType::FEED_ROBOT_1, { "WheatRobot1", true, "MiniRobot", "Battery1" }},
		{ActorType::FEED_ROBOT_2, { "WheatRobot2", true, "MiniRobot", "Battery2" }},
		{ActorType::FEED_ROBOT_3, { "WheatRobot3", true, "MiniRobot", "Battery3" }},
		{ActorType::FEED_ROBOT_4, { "WheatRobot4", true, "MiniRobot", "Battery4" }},
